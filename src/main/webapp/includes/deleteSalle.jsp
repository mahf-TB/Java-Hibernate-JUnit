<div id="modalDeleteSalle" class="fixed inset-0 hidden bg-gray-900/50 flex items-center justify-center">
    <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <form id="deleteForm" method="POST" action="/GestionSalles/salle-servlet">
...
<script defer>
    ...
    function openModalDelete(id) {
        ...
        document.getElementById('modalDeleteSalle').classList.remove('hidden');
    }

    function closeModalDelete() {
        document.getElementById('modalDeleteSalle').classList.add('hidden');
    }
</script>
<div id="modalDeleteOccuper" class="fixed inset-0 hidden bg-gray-900/50 flex items-center justify-center m-0">
    <div class="bg-white p-6 rounded-lg shadow-lg w-1/3">
        ...
        <form id="deleteForm" method="POST" action="/GestionSalles/occuper-servlet">
...
<script defer>
    ...
    function openModalDelete(id) {
        ...
        document.getElementById('modalDeleteOccuper').classList.remove('hidden');
    }

    function closeModalDelete() {
        document.getElementById('modalDeleteOccuper').classList.add('hidden');
    }
</script>